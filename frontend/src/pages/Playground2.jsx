...
const LEVEL_DIM    = ["#e0f2fe", "#ede9fe", "#d1fae5", "#ffedd5"]
    ...
    <div style={{
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", lineHeight: 1.2 }}>
          <span style={{ fontSize: 13, fontWeight: 700, letterSpacing: "0.12em", color: "#0f172a" }}>VAJRA</span>
          <span style={{ fontSize: 10, color: "#64748b", letterSpacing: "0.06em" }}>AI SECURITY FRAMEWORK</span>
        </div>
        ...
        <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{
            ...
            <span style={{ fontSize: 11, color: "#64748b" }}>{safetyPct}%</span>
          </div>
          <button
        ...
        >
          <svg width={SIZE} height={SIZE}>
                ...
                return (
                  ...
                  >
                    <path
                      ...
                      stroke={isImpl || isSel || isHov ? accent : "#e2e8f0"}
                    ...
                    <text
                      ...
                      fill={isSel ? accent : isHov ? "#334155" : "#94a3b8"}
            ...
            <g transform={`translate(${CENTER},${CENTER})`}>
              <circle r="36" fill="#ffffff" stroke="#e2e8f0" strokeWidth="1.5"/>
              <circle r="28" fill="none" stroke="#e2e8f0" strokeWidth="3"/>
          ...
          <div style={{ display: "flex", gap: 20, marginTop: 10 }}>
            {[
              { label: "Default", color: "#f8fafc", border: "#cbd5e1" },
              ...
              <div key={item.label} style={{ display: "flex", alignItems: "center", gap: 6 }}>
                <div style={{
                  ...
                  background: item.label === "Default" ? "#f8fafc" : item.color + "22",
        ...
        <div style={{
          ...
          <AnimatePresence mode="wait">
            ...
            {!selected && (
              ...
              >
                <h2 style={{ fontSize: 18, fontWeight: 700, color: "#0f172a", marginBottom: 4, letterSpacing: "0.02em" }}>
                  Security Controls
                </h2>
                ...
                <div style={{
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 14 }}>
                    <div>
                      <div style={{ fontSize: 11, color: "#64748b", marginBottom: 4, letterSpacing: "0.08em" }}>OVERALL SAFETY POSTURE</div>
                      <div style={{ fontSize: 28, fontWeight: 800, color: safetyMeta.color }}>{safetyPct}%</div>
                      <div style={{ fontSize: 11, color: "#64748b" }}>{implementedCount} / {totalControls} controls</div>
                    </div>
                    <div style={{
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                  {levels.map((lvl, i) => {
                    ...
                    return (
                      <div key={i} style={{
                        background: "#ffffff",
                        border: `1px solid ${isOpen ? accent + "80" : "#e2e8f0"}`,
                        borderRadius: 10,
                        overflow: "hidden",
                        ...
                        >
                          ...
                          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                            <div style={{ width: 48, height: 3, background: "#e2e8f0", borderRadius: 4, overflow: "hidden" }}>
                              <div style={{
                          ...
                          {isOpen && (
                            ...
                            >
                              <div style={{ padding: "0 16px 14px", display: "flex", flexDirection: "column", gap: 6 }}>
                                <p style={{ fontSize: 11, color: "#64748b", marginBottom: 8, lineHeight: 1.6, borderTop: "1px solid #e8edf2", paddingTop: 10 }}>
                                  {lvl.desc}
                                </p>
                                  ...
                                  return (
                                    <motion.div
                                      ...
                                      style={{
                                        ...
                                        background: isImpl ? accent + "18" : "#f8fafc",
                                        border: `1px solid ${isImpl ? accent + "60" : "#e2e8f0"}`,
                                        cursor: "pointer",
                                    ...
                                    >
                                      <div style={{
                                        ...
                                        background: isImpl ? accent : "#e2e8f0",
                                        display: "flex", alignItems: "center", justifyContent: "center",
                                        fontSize: 9, color: isImpl ? "#ffffff" : "#94a3b8",
                                        transition: "all 0.2s"
                                      }}>
                                        {isImpl ? "✓" : pi + 1}
                                      </div>
                                      <span style={{ flex: 1, fontSize: 11, color: isImpl ? "#0f172a" : "#475569" }}>
                                        {p.title}
                                      </span>
                                    </motion.div>
                                  )
            ...
            {selected && (
              ...
              >
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 10 }}>
                    ...
                    {implemented[selected.id] && (
                      <motion.span
                        ...
                        style={{
                          fontSize: 10, fontWeight: 700, padding: "3px 10px", borderRadius: 20,
                          background: "#dcfce7", color: "#34d399",
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: 10, color: "#64748b", letterSpacing: "0.06em" }}>SAFETY POSTURE</div>
                ...
                {/* ── RISKS ── */}
                <div style={{
                  background: "#ffffff", border: "1px solid #f87171" + "30",
                    ...
                    {selected.risk.map((r, i) => (
                      ...
                      >
                        <div style={{
                          ...
                          background: "#fca5a5", marginTop: 6, flexShrink: 0
                        }}/>
                        <span style={{ fontSize: 12.5, color: "#64748b", lineHeight: 1.6 }}>{r}</span>
                      </motion.div>
                    ))}
                  </div>
                </div>
                ...
                {selected.mitigation && (
                  <div style={{
                    background: "#ffffff", border: "1px solid #34d39930",
                    borderRadius: 10, padding: "16px 18px", marginBottom: 12
                  }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 10 }}>
                      <div style={{
                    ...
                    <p style={{ fontSize: 12.5, color: "#64748b", lineHeight: 1.7 }}>{selected.mitigation}</p>
                  </div>
                )}
                ...
                <div style={{ marginTop: 16, textAlign: "center", fontSize: 10, color: "#94a3b8", letterSpacing: "0.05em" }}>
